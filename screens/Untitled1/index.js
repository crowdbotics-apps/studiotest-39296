...
const Untitled1 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }} style={styles.hzSbBdMr}><View style={styles.JWncHDQA}><Text style={styles.xzibjkPD}>Managers
Add New</Text></View><Pressable onPress={{}}><Pressable onPress={{}}><View style={styles.BaDhAmNs}><TextInput style={styles.LmuFztZq}></TextInput></View></Pressable></Pressable><Text style={styles.LnMPEWTz}>KOMATSU</Text></ScrollView>
    <ImageBackground style={styles.vDqTqIcR} source={{
